...
- Group features into **Areas** (`area = "Training"`) — each becomes a labelled band with a rotated label in a left gutter, adding no rows and leaving the date lines unbroken. A plan with no Areas renders exactly as before.
...
| [CONTEXT.md](CONTEXT.md)                                                                         | **Ubiquitous language** — the glossary: Macroplan, Feature, Original Estimate, Re-estimate, Delivery, Milestone, Area, Week, Now line, Learning, Status, and the symbol legend                                                                                                               |
| [DESIGN.md](DESIGN.md)                                                                           | **Need-driven design (QFD)** — needs, functions, the Need→Function→How→Component cascade, the House/Roof matrices + rendered House of Quality, critical performance budget, trade-offs, and watched tensions                                                                                 |
...
| [docs/adr/0003-area-is-a-container-not-a-tag.md](docs/adr/0003-area-is-a-container-not-a-tag.md) | Why a Feature belongs to at most one **Area**, rather than carrying many as tags                                                                                                                                                                                                             |
